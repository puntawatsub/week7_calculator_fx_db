...
RUN wget https://download2.gluonhq.com/openjfx/21.0.11/openjfx-21.0.11-ea+2_linux-aarch64_bin-sdk.zip -O /tmp/openjfx.zip && \
...
CMD ["java", "--module-path", "/opt/javafx-sdk-21.0.11/lib", "--add-modules", "javafx.controls,javafx.fxml", "-jar", "target/sum-product_fx-1.0-SNAPSHOT.jar"]