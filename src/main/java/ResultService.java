...
public class ResultService {
    ...
    public static void saveResult(double n1, double n2, double sum, double difference, double product, double quotient) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            // Insert the result
            String insert = "INSERT INTO calc_results (number1, number2, sum_result, difference_result, product_result, quotient_result) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            System.out.println("✅ Result saved: " + n1 + ", " + n2 + " → Sum=" + sum + ", Difference=" + difference + ", Product=" + product + ", Quotient=" + quotient);
